...
namespace std {
    ...
    template<>
    struct enable_bitmask_operators<AVR::ATMega324PB::Usart::UCSRA> {
        static constexpr bool enable = true;
    };
    template<>
    struct enable_bitmask_operators<AVR::ATMega324PB::Usart::UCSRB> {
        static constexpr bool enable = true;
    };
    template<>
    struct enable_bitmask_operators<AVR::ATMega324PB::Usart::UCSRC> {
        static constexpr bool enable = true;
    };
    template<>
