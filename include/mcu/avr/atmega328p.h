...
namespace std {
    template<>
    struct enable_bitmask_operators<AVR::ATMega328P::Status::Bits> {
    ...
    template<>
    struct enable_bitmask_operators<AVR::ATMega328P::Usart::SRA> {
        static constexpr bool enable = true;
    };
    template<>
    struct enable_bitmask_operators<AVR::ATMega328P::Usart::SRB> {
        static constexpr bool enable = true;
    };
    template<>
    struct enable_bitmask_operators<AVR::ATMega328P::Usart::SRC> {
        static constexpr bool enable = true;
    };
    template<>
