...
template<>
struct ATMega1284P::Timer8Bit::Prescaler<0, 0> {
    static constexpr uint8_t value = 0x00;
};
template<>
struct ATMega1284P::Timer8Bit::Prescaler<0, 1> {
    static constexpr uint8_t value = _BV(CS00);
};
template<>
struct ATMega1284P::Timer8Bit::Prescaler<0, 8> {
    static constexpr uint8_t value = _BV(CS01);
};
template<>
struct ATMega1284P::Timer8Bit::Prescaler<0, 64> {
    static constexpr uint8_t value = _BV(CS01) | _BV(CS00);
};
template<>
struct ATMega1284P::Timer8Bit::Prescaler<0, 256> {
    static constexpr uint8_t value = _BV(CS02);
};
template<>
struct ATMega1284P::Timer8Bit::Prescaler<0, 1024> {
...
template<>
struct ATMega1284P::Timer8Bit::Prescaler<2, 0> {
    static constexpr uint8_t value = 0x00;
};
template<>
struct ATMega1284P::Timer8Bit::Prescaler<2, 1> {
    static constexpr uint8_t value = _BV(CS00);
};
template<>
struct ATMega1284P::Timer8Bit::Prescaler<2, 8> {
    static constexpr uint8_t value = _BV(CS01);
};
template<>
struct ATMega1284P::Timer8Bit::Prescaler<2, 32> {
    static constexpr uint8_t value = _BV(CS01) | _BV(CS00);
};
template<>
struct ATMega1284P::Timer8Bit::Prescaler<2, 64> {
    static constexpr uint8_t value = _BV(CS02);
};
template<>
struct ATMega1284P::Timer8Bit::Prescaler<2, 128> {
    static constexpr uint8_t value = _BV(CS02) | _BV(CS00);
};
template<>
struct ATMega1284P::Timer8Bit::Prescaler<2, 256> {
    static constexpr uint8_t value = _BV(CS02) | _BV(CS01);
};
template<>
struct ATMega1284P::Timer8Bit::Prescaler<2, 1024> {
    static constexpr uint8_t value = _BV(CS02) | _BV(CS01) | _BV(CS00);
};

// Timer 1 (16bit)
template<>
struct ATMega1284P::Timer16Bit::PrescalerRow<1> {
...
template<>
struct ATMega1284P::Timer16Bit::Prescaler<1> {
    static constexpr uint8_t value = _BV(CS10);
};
template<>
struct ATMega1284P::Timer16Bit::Prescaler<8> {
    static constexpr uint8_t value = _BV(CS11);
};
template<>
struct ATMega1284P::Timer16Bit::Prescaler<64> {
    static constexpr uint8_t value = _BV(CS11) | _BV(CS10);
};
template<>
struct ATMega1284P::Timer16Bit::Prescaler<256> {
    static constexpr uint8_t value = _BV(CS12);
};
template<>
struct ATMega1284P::Timer16Bit::Prescaler<1024> {
    static constexpr uint8_t value = _BV(CS12) | _BV(CS10);
};

// Timer 3 (16bit)
template<>
struct ATMega1284P::Timer16Bit::PrescalerRow<3> {
    static constexpr uint16_t values[] = {1, 8, 64, 256, 1024};
};
template<>
