...
namespace std {
    ...
    template<>
    struct enable_bitmask_operators<AVR::ATMega88P::Usart::SRA> {
        static constexpr bool enable = true;
    };
    template<>
    struct enable_bitmask_operators<AVR::ATMega88P::Usart::SRB> {
        static constexpr bool enable = true;
    };
    template<>
    struct enable_bitmask_operators<AVR::ATMega88P::Usart::SRC> {
        static constexpr bool enable = true;
    };
    template<>
