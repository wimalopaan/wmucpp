...
public:
    ...
    struct Constants {
        struct Words {
            ...
            static constexpr Util::PgmArray<WordLeds, Es, Ist, Fuenf1, Zehn1, Zwanzig, Drei1, Viertel, Nach, Vor, Halb, Zwoelf, Zwei, Ein, Eins,
        ...
        struct Colors {
            ...
            static constexpr Util::PgmArray<Color, Subst, Verb, Minute, Prep, Quarter, Hour, MinuteRemainder, Off> colors{};
        };
    };
