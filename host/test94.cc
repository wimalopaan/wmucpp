...
//  if (!I2C_GT911_WriteRegister(GT911_CONFIG_REG, (uint8_t *) &TOUCH_GT911_Cfg[0], sizeof(TOUCH_GT911_Cfg)))
//  {
...
int main() {
    I2C_GT911_SendConfig(true);
    
    printf("cs: %x\n", TOUCH_GT911_Cfg[sizeof(TOUCH_GT911_Cfg) - 2]);    
