...
private:
    ...
    static inline params_t params = []{
        ...
        addNode(p, Param_t{parent, PType::U16,  "Sch 1: f/b", nullptr, &eeprom.channels[0].first, 1, 16, [](const uint16_t){return true;}});
        addNode(p, Param_t{parent, PType::U16,  "Sch 1: l/r", nullptr, &eeprom.channels[0].second, 1, 16, [](const uint16_t){return true;}});
        addNode(p, Param_t{parent, PType::U16,  "Sch 2: f/b", nullptr, &eeprom.channels[1].first, 1, 16, [](const uint16_t){return true;}});
        addNode(p, Param_t{parent, PType::U16,  "Sch 2: l/r", nullptr, &eeprom.channels[1].second, 1, 16, [](const uint16_t){return true;}});
        parent = addParent(p, Param_t{0, PType::Folder, "Outputs"});
        addNode(p, Param_t{parent, PType::Sel, "Srv1 Out", "PWM/A;PWM/P;Serial/WS;None", &eeprom.out_mode_srv[0], 0, 3, [](const uint16_t s){servos::template servo<0>(s); return true;}});
        addNode(p, Param_t{parent, PType::Sel, "Srv1 Fb", "Analog;PWM;Serial;None", &eeprom.out_mode_srv[0], 0, 3});
        addNode(p, Param_t{parent, PType::Sel, "Esc1 Out", "PWM/-;E32/S;E32A;VEsc/V;None", &eeprom.out_mode_esc[0], 0, 4, [](const uint16_t s){escs::template esc<0>(s); return true;}});
        addNode(p, Param_t{parent, PType::Sel, "Esc1 Tlm", "Dbg;SPort;Esc32;E32A;VEsc", &eeprom.tlm_mode_esc[0], 0, 4, [](const uint16_t){return true;}});
        addNode(p, Param_t{parent, PType::Sel, "Srv2 Out", "PWM/A;PWM/P;Serial/WS;None", &eeprom.out_mode_srv[1], 0, 3, [](const uint16_t s){servos::template servo<1>(s); return true;}});
        addNode(p, Param_t{parent, PType::Sel, "Srv2 Fb", "Analog;PWM;Serial;None", &eeprom.out_mode_srv[1], 0, 3});
        addNode(p, Param_t{parent, PType::Sel, "Esc2 Out", "PWM/-;E32/S;E32A;VEsc/V;None", &eeprom.out_mode_esc[1], 0, 4, [](const uint16_t s){escs::template esc<1>(s); return true;}});
        addNode(p, Param_t{parent, PType::Sel, "Esc2 Tlm", "SPort;Esc32;E32A;VEsc", &eeprom.tlm_mode_esc[1], 0, 2, [](const uint16_t){return true;}});
