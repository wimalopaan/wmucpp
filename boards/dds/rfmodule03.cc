...
struct Fsm {
    ...
    static inline constexpr uint8_t ProtoNumber{88}; // WM-FM    
    static inline constexpr uint8_t BindOnChannelChannel{15}; // channel 16    
    ...
    static inline void ratePeriodic() {
        ...
        if (oldState != mState) {
            ...
            case State::RunCheck:
                ...
                led::color(yellow);
                blinkLed::blink(bc_t{1});
                mLastValueChannel16 = mpm_pa::value(BindOnChannelChannel);
                break;
            case State::RunRF:
...
private:
    static inline mpm_pa::value_type mLastValueChannel16{};
