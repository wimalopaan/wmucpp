...
using devs = Devices<CC10, DevsConfig, Mcu::Stm::Stm32G0B1>;
...
void USART2_LPUART2_IRQHandler() {
    using crsf2 = devs::crsf2;
    static_assert(crsf2::uart::number == 2);
    crsf2::Isr::onIdle([] static {});
    crsf2::Isr::onTransferComplete([] static {});
}
void USART3_4_5_6_LPUART1_IRQHandler() {
    using crsf3 = devs::crsf3;
    static_assert(crsf3::uart::number == 3);
    crsf3::Isr::onIdle([] static {});
    crsf3::Isr::onTransferComplete([] static {});
}
