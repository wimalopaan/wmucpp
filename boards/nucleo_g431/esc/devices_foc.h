...
struct Devices<ESC_FOC_02, Config, Mcu::Stm::Stm32G431> {
...
//    using tp3 = Mcu::Stm::Pin<gpiob, 1, MCU>; // opamp3_out
    ...
    // Timer 6
    using timer_prescaler = std::integral_constant<uint16_t, 169>; // 1 MHz
    using measurement = Mcu::Stm::Motor::Measurement<6, timer_prescaler, driver, MCU>;
...
//    using pga3 = Mcu::Stm::PGA<3>; // PB0, PB2
    ...
    // Timer 7 
    using pos_estimator = Mcu::Stm::Motor::Estimator<7, timer_prescaler, driver, measurement, dac3, MCU>; 
    
    // Timer 4
    using hall = Mcu::Stm::Hall<4, timer_prescaler, driver, pos_estimator, measurement, MCU>;
    
    using adc1 = Mcu::Stm::Adc<1, 11, driver, Mcu::Stm::UseDma<true>, MCU>; 

    using spi1 = Mcu::Stm::Spi<1, MCU>;
...
//    using pos_prescaler = std::integral_constant<uint16_t, 169>; // 1Mhz
    ...
    // Timer 7 
    using pos_estimator = Mcu::Stm::Motor::Estimator<7, pos_prescaler, driver, measurement, void, MCU>; 
