...
struct GlobalFsm {
    ...
    using pa = Devs::servo_pa;
    
    using TermDev = Devs::terminal::device_type;
    
    using adc_i_t = Devs::adc::index_type;
...
struct BusDevs<External::Bus::IBusIBus<Devs>> {
    ...
    using sensor = External::SPort::Sensor<External::SPort::SensorId::ID1, sensorUsart, systemTimer, Meta::List<>>;
