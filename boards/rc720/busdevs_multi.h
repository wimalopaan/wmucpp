...
//    using fsm6 = FSM<pwm5, servo_pa, eeprom, 5>;
    ...
    using fsm1 = FSM<pwm0, servo_pa, eeprom, 0>; // S1
    using fsm2 = FSM<pwm1, servo_pa, eeprom, 5>; // S2
    using fsm3 = FSM<pwm2, servo_pa, eeprom, 2>; // P1
    using fsm4 = FSM<pwm3, servo_pa, eeprom, 3>; // P2
    using fsm5 = FSM<pwm4, servo_pa, eeprom, 1>; // O1
    using fsm6 = FSM<pwm5, servo_pa, eeprom, 4>; // O2
