...
using portmux = Portmux::StaticMapper<Meta::List<usart0Position, usart1Position, usart3Position, tcaPosition, tcbPosition, ccl0Position>>;
    ...
    while(true) {
        ...
        systemTimer::periodic([&]{
            ...
            alarmTimer::periodic([&](const auto& t){
                if (periodicTimer == t) {
                    led::toggle();
                    etl::outl<terminal>("test06: "_pgm, ++counter, " ch0: "_pgm, sumd::value(0).toInt());
