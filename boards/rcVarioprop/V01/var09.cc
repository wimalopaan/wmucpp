...
struct GFSM {
    ...
    enum class State : uint8_t {Undefined, Init, Run, Reset, Test,
                                // RfOn, RfOff,
                                Set};
    ...
    static inline void ratePeriodic() {
        ...
        case State::Run:
            ...
            devs::CrsfCallback::whenAlternateDataChanged([](const uint8_t i, const uint8_t v){
                IO::outl<trace>("adata: ", i, " ", v);
                Data::switches[i] = v;
            });
