...
using usart1Position = Portmux::Position<Component::Usart<0>, Portmux::Default>; // Sensor
using portmux = Portmux::StaticMapper<Meta::List<usart1Position>>;

using systemTimer = SystemTimer<Component::Rtc<0>, Parameter::fRtc>;

using telemetry = Hott::Experimental::Sensor<usart1Position, AVR::Usart, AVR::BaudRate<19200>, Hott::GamMsg, Hott::VarTextMsg<2>, systemTimer>;
