...
namespace External {
    ...
    template<AVR::Concepts::ComponentPosition CP, typename Timer, typename term>
    struct SSD1306<CP, Timer, term> {
        ...
        static inline constexpr External::Tick<Timer> refreshTicks{20_ms};
        ...
        using i2c = AVR::Twi::Master<CP, frameBuffer>;
