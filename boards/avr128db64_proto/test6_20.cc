    ...
    static void ratePeriodic() {
        ...
        case State::On:
            ...
            mDebugTicks.testForNext(debugTicks, [&]{
                ...
                break;
                case 1:
                    devs::rmc::timeRaw(timeBuffer);
                    devs::rmc::dateRaw(dateBuffer);
                    devs::vtg::speedRaw(speedBuffer);
                    ...
                    etl::outl<terminal2>("serial2: "_pgm, timeBuffer);
                break;
                case 2:
                    etl::outl<terminal3>("t6_20 r:"_pgm, (uint8_t)devs::rmc::receivedPackages(),"v"_pgm, (uint8_t)devs::vtg::receivedPackages(), "g"_pgm, (uint8_t)devs::gsv::receivedPackages());                
                break;
                case 3:
                ...
                break;
                case 7:
                    etl::outl<terminal3>("a[0]:"_pgm, a0, " "_pgm, timeBuffer);                
                break;
                case 8:
                    etl::outl<terminal3>("a[1]:"_pgm, a1, " "_pgm, dateBuffer);                
                break;
                case 9:
                    etl::outl<terminal3>("a[2]:"_pgm, a2, " "_pgm, speedBuffer);                
                    return true;
                break;
                }
                return false;
...
private:    
    ...
    static inline etl::StringBuffer<External::GPS::Sentence::DateMaxWidth> dateBuffer;
    static inline etl::StringBuffer<External::GPS::Sentence::DecimalMaxWidth> speedBuffer;
