...
struct Devices<5, MCU> {
    ...
    using twi0Position = AVR::Portmux::Position<AVR::Component::Twi<0>, AVR::Portmux::Alt2>;
...
//    using terminal1 = etl::basic_ostream<serial1>;
    ...
    using hc05 = External::HC05<"abc"_pgm, bluetoothUsart, bluetoothEnable, bluetoothPower, systemTimer, terminal2>;
    ...
    using pwrGPS = AVR::ActiveLow<AVR::Pin<AVR::Port<AVR::F>, 4>, AVR::Output>; 
    ...
    using pc2  = AVR::ActiveLow<AVR::Pin<AVR::Port<AVR::C>, 3>, AVR::Output>; 
...
//    using oled = External::SSD1306<oledI2C, systemTimer, terminal1>;
    using oled = External::SSD1306<twi0Position, systemTimer, terminal2>;
    ...
    using bec_en = AVR::ActiveLow<AVR::Pin<AVR::Port<AVR::A>, 7>, AVR::Output>; 
...
struct Devices<4, MCU> {
    ...
    using oledI2C = AVR::Twi::Master<twi0Position, etl::NamedConstant<128>>;
    using rtcI2C = AVR::Twi::Master<twi1Position, etl::NamedConstant<32>>;
