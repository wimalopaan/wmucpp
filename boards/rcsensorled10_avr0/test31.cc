...
public:
    Dashboard() : Menu(this, "Dashboard"_pgm, &mRpm1, &mRpm2
                       ) {}
private:
...
struct AsciiHandler final {
    AsciiHandler() = delete;
    static void start() {
#ifdef OUTPUT
//        etl::outl<terminal>("ha start"_pgm);
#endif
...
//        etl::outl<terminal>("key: "_pgm, key);
        menu::isrKey(key);        
    }
};
struct BinaryHandler final {
