...
namespace BLDC {
    ...
    namespace Sine10 {
        ...
        struct Controller {
            ...
            static inline constexpr uint16_t SpeedMax = 5000 / 8;
            using speed_t = etl::uint_ranged<uint16_t, 0, SpeedMax>;
            
            constinit static inline scale_type mScaleStart{0.3};
            constinit static inline volatile scale_type mScale{};
            
            constinit static inline Control::PID currentPid{fpq10{0.01}, fpq10{0.005}, fpq10{0.0}, 100, 30};
            constinit static inline Control::PID periodPid{fpq10{0.1}, fpq10{0.005}, fpq10{0.1}, 100, 200};
            
            struct SineCurrent {
                constexpr inline explicit SineCurrent(uint16_t start, uint16_t end, uint16_t max) : mStart{start}, mEnd{end}, mMax{max} {
                    assert(mEnd >= mStart);
                    assert(mMax >= mStart);
                    mDiff = mEnd - mStart;
                }
                ...
                constexpr inline const uint16_t& diff() const {
                    return mDiff;
                }
            ...
            struct SineConfig {
                ...
                constexpr inline const speed_t& stat() const {
                    return mS_Static;
                }
                ...
                constexpr inline const speed_t& regStaticDiff() const {
            ...
            using period_t = etl::uint_ranged_NaN<uint16_t, 1000, 20000>;
            ...
            constinit inline static std::array<speed_t, sinePhaseLength.size()> sineSpeeds{};
            constinit inline static uint16_t mP_Dead = 10000;
            ...
            constinit static inline Config config;
...
//                    });
        ...
        constinit static inline speed_t actualSpeed = 0;

        constinit static inline uint8_t rateCounter = 0;
        ...
        inline static void ratePeriodic() {
            ...
            TRACE;
            speed_value = SpeedValue{actualSpeed};
        ...
        constinit inline static speed_t desiredSpeed = 0;
