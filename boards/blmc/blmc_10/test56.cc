...
using controller = BLDC::Sine5::Controller<rotationTimer, commuteTimer, pwm, commuter, adcomp>;
...
//            sensor::periodic();
            ...
            systemTimer::periodic([&]{
                ...
                if (controller::mState == controller::State::Sine) {
                    ...
                    fp = (7 * fp + controller::mActualPeriodLoop) / 8;                    
                ...
                alarmTimer::periodic([&](const auto& t){
                    if (t == periodicTimer) {
                        etl::outl<terminal>("p: "_pgm, controller::mActualPeriod.toInt(), " t: "_pgm, controller::mActualSineTable.toInt(), 
                                            ...
                                            " fp: "_pgm, fp, " pwm: "_pgm, controller::mActualPwm);            
