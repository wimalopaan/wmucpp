...
using controller = BLDC::Sine7::Controller<rotationTimer, commuteTimer, pwm, commuter, adcomp, currentSensor>;
...
//                                            " pwm: "_pgm, controller::mActualPwm);            
                        etl::outl<terminal>(" cv: "_pgm, controller::cv, " cc: "_pgm, controller::mCurrentSine,
                                            " cvp: "_pgm, controller::cvp
                                            );
                    }
