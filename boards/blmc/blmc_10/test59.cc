...
using commuter = BLDC::Communter<adcomp, pwm, Meta::List<pinLow0, pinLow1, pinLow2>, void>;

using controller = BLDC::Sine8::Controller<rotationTimer, commuteTimer, pwm, commuter, adcomp, currentSensor>;
...
//    ppm::init();
    ...
    etl::uint_ranged<uint16_t, 0, 1000> speed{};
    
    {
        etl::Scoped<etl::EnableInterrupt<>> ei;
        etl::outl<terminal>("Test59"_pgm);
...
//        etl::outl<terminal>("fpmin: "_pgm, etl::FixedPoint<int16_t, 10>::min());            
//        etl::outl<terminal>("fpmax: "_pgm, etl::FixedPoint<int16_t, 10>::max());            
                ...
                alarmTimer::periodic([&](const auto& t){
                    if (t == periodicTimer) {
                        ...
                        etl::outl<terminal>(" apwm: "_pgm, controller::mActualPwm, " s: "_pgm, controller::mScale
                                            , " ape: "_pgm, controller::mActualPeriodEstimate, " dp: "_pgm, controller::mDesiredPeriod
                                            , " npw: "_pgm, controller::npwm, " d1:"_pgm, controller::d1
                                            , " ap: "_pgm, controller::mActualPeriod.toInt(), " at: "_pgm, controller::mActualSineTable.toInt());
                    }
