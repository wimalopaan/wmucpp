...
using controller = BLDC::Sine9::Controller<rotationTimer, commuteTimer, pwm, commuter, adcomp, currentSensor, dbg>;
...
int main() {
    ...
    
    {
        ...
        for(auto s: BLDC::Sine9::sineSpeeds) {
...
//                        etl::outl<terminal>("ppm: "_pgm, ppm::value().toInt());
                        etl::outl<terminal>("S: "_pgm, uint8_t(controller::mState), " cPID: "_pgm, BLDC::Sine9::currentPid, " pPID: "_pgm, BLDC::Sine9::periodPid);
                        etl::outl<terminal>(" apwm: "_pgm, controller::mActualPwm, " s: "_pgm, BLDC::Sine9::mScale
                                            , " ape: "_pgm, controller::mActualPeriodEstimate, " dp: "_pgm, controller::desiredRtcPeriod()
                                            , " npw: "_pgm, controller::npwm
                                            , " ap: "_pgm, controller::speed_value.period().toInt(), " at: "_pgm, controller::speed_value.sineTable().toInt()
                                            );
