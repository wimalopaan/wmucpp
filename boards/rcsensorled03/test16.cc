...
public:
    ActorMenu(Hott::Menu* parent) : Menu(parent, "Aktoren"_pgm, &mPWM, &mLeds, &mDevs) {}
private:
    PWMMenu   mPWM{this};                        
    LedMenu   mLeds{this};                        
    I2CMenu   mDevs{this};                        
...
// fixme: keine extra Klassen, denn das ergibt immer VTables -> test17
class RCMenu final : public Hott::Menu {
public:
    RCMenu() : Menu(this, "WM SensMod HW 3 SW 16"_pgm, &mInfo, &mTemperatur, &mSpannung, &mDrehzahl, &mStrom, &mActors) {}
private:
    InfoMenu mInfo{this};
