...
namespace Constants {
    ...
    static constexpr auto title = "Test 01 Board 03"_pgm;
}
...
using distributor = Distributor<isrRegistrar, statusLed, crWriterSensorBinary, crWriterSensorText, adcController, ds18b20, rpm2>;
