...
const auto tempTimer = alarmTimer::create(3000_ms, AlarmFlags::Periodic);
const auto measureTimer = alarmTimer::create(750_ms, AlarmFlags::Disabled | AlarmFlags::OneShot);

bool readOneWire = false;
...
int main() {
    ...
    
    {
        ...
        while(true){
            ...
            systemClock::periodic<systemClock::flags_type::ocfa>([](){
                ...
                alarmTimer::periodic([](uint7_t timer){
                    if (timer == *periodicTimer) {
                        ...
                        readOneWire = true;
                        ds18b20::startGet(Storage::dsIds[0]);
                    }
            ...
            if (readOneWire) {
                bool ready = ds18b20::periodic([]{
                    std::outl<terminal>("temp read: "_pgm, ds18b20::temperature());
                });
                if (ready) {
                    readOneWire = false;
                }
