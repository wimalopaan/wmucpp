...
namespace Constants {
    ...
    static constexpr auto title = "Test 06"_pgm;
}
...
using distributor = Distributor<terminalDevice, isrRegistrar, statusLed, crWriterSensorBinary, crWriterSensorText, adcController>;
