...
namespace Constants {
    ...
    static constexpr auto title = "Test 14"_pgm;
}
...
using distributor = Distributor<isrRegistrar, statusLed, crWriterSensorBinary, crWriterSensorText, adcController, ds18b20, rpm>;
...
int main() {
...

    {
        ...
        std::outl<terminal>("pwm: "_pgm, hbridge::frequency());
