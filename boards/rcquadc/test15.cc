...
struct ChannelFsm {
    ...
    enum class State : uint8_t {Init = 0, 
                                ...
                                SettingsBegin = 20, SetForwardPwm = SettingsBegin, SetBackwardPwm, SetForwardOC, SetBackwardOC, SetRamp, SetStartOffCFactor, SetPassThru, SettingsEnd = SetPassThru, 
                                SetForwardPwmOff = 30, SetBackwardPwmOff,  
    ...
    enum class Event : uint8_t {None, Stop, 
                                ...
                                SetStartOffCFactor, SetPassThru, SetRamp
                               };
#ifdef USE_IBUS
...
public:
    ...
    inline static void ratePeriodic() {
        ...
        case State::Off:
            ...
            else if (e == Event::SetPassThru) {
                mState = State::SetPassThru;
            }
            else if (e == Event::SetRamp) {
                mState = State::SetRamp;
            }
            else if (e == Event::SetStartOffCFactor) {
                mState = State::SetStartOffCFactor;
            }
            break;
        ...
        case State::OffBackwardEnd:
            ...
            break;
        case State::SetPassThru:
            if (e != Event::None) {
                if (e == Event::SetPassThru) {
                }
                else {
                    mState = State::OffWait;                
                }
        ...
        case State::SetRamp:
            ...
            break;
        case State::SetStartOffCFactor:
            if (e != Event::None) {
                if (e == Event::SetStartOffCFactor) {
                }
                else {
                    mState = State::OffWait;                
                }
        ...
        if (oldState != mState) {
            ...
            case State::OffBackwardEnd:
                ...
                break;
            case State::SetPassThru:
                etl::outl<Term>("S spt: "_pgm);
                off();
                break;
            case State::SetRamp:
                etl::outl<Term>("S sra: "_pgm);
                off();
                break;
            case State::SetStartOffCFactor:
                etl::outl<Term>("S sra: "_pgm);
