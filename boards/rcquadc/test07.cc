...
//                                SetForwardPwmReleaseBackward, SetBackwardPwmReleaseForward
    ...
    static inline constexpr External::Tick<Timer> setPwmTimeout{3000_ms};
    ...
    static inline auto& forwardRefCurr() {
        return NVM::data().output(data_index).forwardRefC;        
    }
    static inline auto& backwardRefCurr() {
        return NVM::data().output(data_index).backwardRefC;        
    }
    ...
    static inline void debug() {
        ...
        etl::out<Term>(" frc: "_pgm, forwardRefCurr(), " foc: "_pgm, forwardOffCurr());
