...
//template<typename GP, typename Serials>
//struct Selector;

//template<typename GP, typename... S>
//struct Selector<GP, Meta::List<S...>> {
//    static_assert(GP::Size == sizeof...(S));
    
//    using slist = Meta::List<S...>;
