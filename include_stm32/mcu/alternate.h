...
namespace Mcu::Stm {
    namespace AlternateFunctions {
        ...
        namespace detail {
			...
			template<Mcu::Stm::G4xx MCU>
            struct Impl<Pin<B, 6>, Timer<4>, CC<1>, MCU> : std::integral_constant<uint8_t, 2> {};
            template<Mcu::Stm::G4xx MCU>
            struct Impl<Pin<B, 7>, Timer<4>, CC<2>, MCU> : std::integral_constant<uint8_t, 2> {};
            template<Mcu::Stm::G4xx MCU>
            struct Impl<Pin<B, 8>, Timer<4>, CC<3>, MCU> : std::integral_constant<uint8_t, 2> {};
            template<Mcu::Stm::G4xx MCU>
            struct Impl<Pin<B, 9>, Timer<4>, CC<4>, MCU> : std::integral_constant<uint8_t, 2> {};
			...
			template<Mcu::Stm::G4xx MCU>
            struct Impl<Pin<A, 2>, Usart<2>, TX, MCU> : std::integral_constant<uint8_t, 7> {};
            template<Mcu::Stm::G4xx MCU>
            struct Impl<Pin<A, 3>, Usart<2>, RX, MCU> : std::integral_constant<uint8_t, 7> {};
            ...
            template<Mcu::Stm::G4xx MCU>
            struct Impl<Pin<A, 3>, Usart<101>, RX, MCU> : std::integral_constant<uint8_t, 12> {};
			
			template<Mcu::Stm::G4xx MCU>
            struct Impl<Pin<A, 10>, SPI<2>, MISO, MCU> : std::integral_constant<uint8_t, 5> {};
			template<Mcu::Stm::G4xx MCU>
            struct Impl<Pin<A, 11>, SPI<2>, MOSI, MCU> : std::integral_constant<uint8_t, 5> {};
			template<Mcu::Stm::G4xx MCU>
            ...
            template<Mcu::Stm::G0xx MCU>
            struct Impl<Pin<B, 6>, Timer<1>, CC<3>, MCU> : std::integral_constant<uint8_t, 1> {};
            ...
            template<Mcu::Stm::G0xx MCU>
            struct Impl<Pin<A, 3>, Usart<2>, RX, MCU> : std::integral_constant<uint8_t, 1> {};
            ...
            template<Mcu::Stm::G0xx MCU>
            struct Impl<Pin<B, 6>, Usart<102>, TX, MCU> : std::integral_constant<uint8_t, 10> {};
			...
			template<Mcu::Stm::G0xx MCU>
            struct Impl<Pin<A, 5>, Usart<6>, RX, MCU> : std::integral_constant<uint8_t, 3> {};
			...
			template<Mcu::Stm::G0xx MCU>
            struct Impl<Pin<B, 1>, Usart<5>, RX, MCU> : std::integral_constant<uint8_t, 8> {};

            template<Mcu::Stm::G0xx MCU>
            struct Impl<Pin<B, 3>, Usart<5>, TX, MCU> : std::integral_constant<uint8_t, 3> {};
            template<Mcu::Stm::G0xx MCU>
            struct Impl<Pin<B, 4>, Usart<5>, RX, MCU> : std::integral_constant<uint8_t, 3> {};
            ...
            template<Mcu::Stm::G0xx MCU>
            struct Impl<Pin<A, 5>, Usart<3>, TX, MCU> : std::integral_constant<uint8_t, 4> {};
			...
			template<Mcu::Stm::G0xx MCU>
			struct Impl<Pin<B, 8>, Usart<3>, TX, MCU> : std::integral_constant<uint8_t, 4> {};
