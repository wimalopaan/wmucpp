...
namespace Mcu::Stm {
    ...
    template<>
    struct Address<Mcu::Components::DmaChannel<Mcu::Components::Dma<1>, 8>> {
        static inline constexpr uintptr_t value = DMA1_Channel8_BASE;
    ...
    struct Address<Mcu::Components::DmaChannel<Mcu::Components::Dma<2>, 5>> {
        ...
        static inline constexpr uintptr_t mux = DMAMUX1_Channel12_BASE;
    };
    template<>
    struct Address<Mcu::Components::DmaChannel<Mcu::Components::Dma<2>, 6>> {
        ...
        static inline constexpr uintptr_t mux = DMAMUX1_Channel13_BASE;
    };
    template<>
    struct Address<Mcu::Components::DmaChannel<Mcu::Components::Dma<2>, 7>> {
        static inline constexpr uintptr_t value = DMA2_Channel7_BASE;
        static inline constexpr uintptr_t mux = DMAMUX1_Channel14_BASE;
    };
    template<>
    struct Address<Mcu::Components::DmaChannel<Mcu::Components::Dma<2>, 8>> {
        static inline constexpr uintptr_t value = DMA2_Channel8_BASE;
        static inline constexpr uintptr_t mux = DMAMUX1_Channel15_BASE;
    };
}
