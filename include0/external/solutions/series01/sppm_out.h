...
namespace External {
    namespace Ppm {
        ...
        template<typename TN, typename ChannelList = Meta::List<>, typename Pre = std::integral_constant<uint8_t, 8>, typename MCU = DefaultMcuType>
        struct PpmOut;

        template<auto TN, typename Pos, typename... Channels,  AVR::Concepts::AtDxSeries MCU, typename Pre>
        struct PpmOut<AVR::Portmux::Position<AVR::Component::Tca<TN>, Pos>, Meta::List<Channels...>, Pre, MCU> {
...
//                std::integral_constant<decltype(value), value>::_;
        ...
        template<auto TN, typename Pos, typename... Channels, typename Pre, AVR::Concepts::At01Series MCU>
        struct PpmOut<AVR::Portmux::Position<AVR::Component::Tca<TN>, Pos>, Meta::List<Channels...>, Pre, MCU> {
            using mcu_timer_t = typename MCU::TCA; 
            static constexpr auto mcu_tca = AVR::getBaseAddr<mcu_timer_t, TN>;
            using position = AVR::Portmux::Position<AVR::Component::Tca<TN>, Pos>;
...
//                std::integral_constant<decltype(value), value>::_;
        ...
        template<auto TN, typename Pos, typename... CHs, typename Pre, AVR::Concepts::AtDxSeries MCU>
        struct PpmOut<AVR::Portmux::Position<AVR::Component::Tcb<TN>, Pos>, Meta::List<CHs...>, Pre, MCU> {
...
//            std::integral_constant<uint16_t, period>::_;
            ...
            static inline void init() {
                *mcu_tcb()->cnt = 0xffff;
                mcu_tcb()->ctrla.template set<mcu_timer_t::CtrlA_t::clktca0 | mcu_timer_t::CtrlA_t::enable>();
        ...
        template<auto TN, typename Pos, typename List, typename Pre, AVR::Concepts::At01Series MCU>
        struct PpmOut<AVR::Portmux::Position<AVR::Component::Tcb<TN>, Pos>, List, Pre, MCU> {
            using mcu_timer_t = typename MCU::TCB; 
            static constexpr auto mcu_tcb = AVR::getBaseAddr<mcu_timer_t, TN>;
            using position = AVR::Portmux::Position<AVR::Component::Tcb<TN>, Pos>;
