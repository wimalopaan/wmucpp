...
namespace AVR {
    ...
    template<AVR::Concepts::IServiceR... HH> // ICE triggered, nicht mehr mit gcc-8.0
    struct IsrRegistrar {
        ...
        template<uint8_t In, uint8_t N, AVR::Concepts::IServiceR H, AVR::Concepts::IServiceR... Hp>
        struct Caller {
