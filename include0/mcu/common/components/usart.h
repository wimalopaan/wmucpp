...
//            static constexpr const uint8_t count = 4;
            ...
            enum class CtrlA_t : uint8_t {
                ...
                rs485_1 = USART_RS485_1_bm,
                rs485_0 = USART_RS485_0_bm,
            };
            ...
            enum class CtrlB_t : uint8_t {
                ...
                odme = USART_ODME_bm,
                rxm0= USART_RXMODE_0_bm,
                rxm1= USART_RXMODE_1_bm,
                mpcm= USART_MPCM_bm,
            };
            ControlRegister<Usart, CtrlB_t> ctrlb;

            enum class CtrlC_t : uint8_t {
                cmode1 = USART_CMODE_1_bm,
                cmode0 = USART_CMODE_0_bm,
                pmode1 = USART_PMODE_1_bm,
                pmode0 = USART_PMODE_0_bm,
                sbmode = USART_SBMODE_bm,
                xfer1stopbit = 0x00,
                xfer2stopbit = 0x01 << 3,
                chsize2 = USART_CHSIZE_2_bm,
                chsize1 = USART_CHSIZE_1_bm,
                chsize0 = USART_CHSIZE_0_bm,
                xfer8bit = USART_CHSIZE_1_bm | USART_CHSIZE_0_bm,
                noparity = 0x00,
                evenparity = (0x02) << 4,
            };
