...
namespace AVR {
    namespace SeriesDa {
        struct Ccl {
            ...
            ControlRegister<Ccl, SeqCtrl2_t> seqctrl2;
            ...
            ControlRegister<Ccl, IntCtrl1_t> intctrl1;
            ...
            enum class Lut0CtrlA_t : uint8_t {
                ...
                clk_hf = CCL_CLKSRC_OSCHF_gc,
                clk_32K = CCL_CLKSRC_OSC32K_gc,
                clk_1K = CCL_CLKSRC_OSC1K_gc,
            ...
            union Luts {
                ...
                struct Typed {
                    ...
                    enum class Lut0CtrlB_t : uint8_t {
                        ...
                        in1_in1 = CCL_INSEL1_IN1_gc,
                        in1_ac1 = CCL_INSEL1_AC1_gc,
                        ...
                        in0_in0 = CCL_INSEL0_IN0_gc,
                        in0_ac0 = CCL_INSEL0_AC0_gc,
                        in0_zcd0 = CCL_INSEL0_ZCD0_gc,
                    ...
                    enum class Lut0CtrlC_t : uint8_t {
                        ...
                        in2_in2 = CCL_INSEL2_IN2_gc,
                        in2_ac2 = CCL_INSEL2_AC2_gc,
                    ...
                    enum class Lut4CtrlA_t : uint8_t {
                        edge = CCL_EDGEDET_bm,
                        outenable = CCL_OUTEN_bm,
                        filter_disable = CCL_FILTSEL_DISABLE_gc,
                        filter_synch = CCL_FILTSEL_SYNCH_gc,
                    ...
                    ControlRegister<Ccl, Lut4CtrlA_t> lut4ctrla;
                    
                    enum class Lut4CtrlB_t : uint8_t {
                        in1_mask = CCL_INSEL1_MASK_gc,
                        in1_feedback = CCL_INSEL1_FEEDBACK_gc,
                        in1_link = CCL_INSEL1_LINK_gc,
                        in1_eventa = CCL_INSEL1_EVENTA_gc,
                    ...
                    ControlRegister<Ccl, Lut4CtrlB_t> lut4ctrlb;
                    
                    enum class Lut4CtrlC_t : uint8_t {
                        in2_mask = CCL_INSEL2_MASK_gc,
                        in2_feedback = CCL_INSEL2_FEEDBACK_gc,
                        in2_link = CCL_INSEL2_LINK_gc,
                        in2_eventa = CCL_INSEL2_EVENTA_gc,
                    ...
                    ControlRegister<Ccl, Lut4CtrlC_t> lut4ctrlc;
                    
                    DataRegister<Ccl, ReadWrite, std::byte> truth4;

                    
                    enum class Lut5CtrlA_t : uint8_t {
                        edge = CCL_EDGEDET_bm,
                        outenable = CCL_OUTEN_bm,
                        filter_disable = CCL_FILTSEL_DISABLE_gc,
                        filter_synch = CCL_FILTSEL_SYNCH_gc,
                    ...
                    ControlRegister<Ccl, Lut5CtrlA_t> lut5ctrla;
                    
                    enum class Lut5CtrlB_t : uint8_t {
                        in1_mask = CCL_INSEL1_MASK_gc,
                        in1_feedback = CCL_INSEL1_FEEDBACK_gc,
                        in1_link = CCL_INSEL1_LINK_gc,
                        in1_eventa = CCL_INSEL1_EVENTA_gc,
                    ...
                    ControlRegister<Ccl, Lut5CtrlB_t> lut5ctrlb;
                    
                    enum class Lut5CtrlC_t : uint8_t {
                        in2_mask = CCL_INSEL2_MASK_gc,
                        in2_feedback = CCL_INSEL2_FEEDBACK_gc,
                        in2_link = CCL_INSEL2_LINK_gc,
                        in2_eventa = CCL_INSEL2_EVENTA_gc,
                    ...
                    ControlRegister<Ccl, Lut5CtrlC_t> lut5ctrlc;
                    
                    DataRegister<Ccl, ReadWrite, std::byte> truth5;
