...
namespace AVR {
    namespace SeriesDa {
        struct Events {
            ...
            ControlRegister<Events, Strobe_t> strobe1;
            ControlRegister<Events, Strobe_t> strobe2;
...
//        std::integral_constant<size_t, sizeof(Events)>::_;
        
        static_assert(sizeof(Events) == 86);
    }
}
