...
namespace std {
    template<> struct enable_bitmask_operators<AVR::Series1::PortRegister::PinCtrl_t> : std::true_type {};
    
    template<> struct enable_bitmask_operators<AVR::Series2::Adc::CtrlC_t> : std::true_type {};
    template<> struct enable_bitmask_operators<AVR::SeriesDa::Usart::CtrlA_t> : std::true_type {};
    template<> struct enable_bitmask_operators<AVR::SeriesDa::Usart::CtrlB_t> : std::true_type {};
    template<> struct enable_bitmask_operators<AVR::SeriesDa::Usart::CtrlC_t> : std::true_type {};
    ...
    template<> struct enable_bitmask_operators<AVR::Series2::Ccl::CtrlA_t> : std::true_type {};
    template<> struct enable_bitmask_operators<AVR::Series2::Ccl::Lut0CtrlA_t> : std::true_type {};
