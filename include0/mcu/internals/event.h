...
//           template<AVR::Concepts::Letter L, uint8_t N> struct Pin;
        ...
        namespace Users {
            ...
            namespace detail {
                ...
                template<AVR::Concepts::AtDa32 MCU> struct user_to_index<Adc0, MCU> : std::integral_constant<uint8_t,     0x0c>{};
                template<AVR::Concepts::AtDa32 MCU> struct user_to_index<EvOut<A>, MCU> : std::integral_constant<uint8_t, 0x0e>{};
                template<AVR::Concepts::AtDa32 MCU> struct user_to_index<EvOut<B>, MCU> : std::integral_constant<uint8_t, 0x0f>{};
                template<AVR::Concepts::AtDa32 MCU> struct user_to_index<EvOut<C>, MCU> : std::integral_constant<uint8_t, 0x10>{};
                template<AVR::Concepts::AtDa32 MCU> struct user_to_index<EvOut<D>, MCU> : std::integral_constant<uint8_t, 0x11>{};
                template<AVR::Concepts::AtDa32 MCU> struct user_to_index<EvOut<E>, MCU> : std::integral_constant<uint8_t, 0x12>{};
                template<AVR::Concepts::AtDa32 MCU> struct user_to_index<EvOut<F>, MCU> : std::integral_constant<uint8_t, 0x13>{};
                template<AVR::Concepts::AtDa32 MCU> struct user_to_index<Usart<0>, MCU> : std::integral_constant<uint8_t, 0x15>{};
                template<AVR::Concepts::AtDa32 MCU> struct user_to_index<Usart<1>, MCU> : std::integral_constant<uint8_t, 0x16>{};
                template<AVR::Concepts::AtDa32 MCU> struct user_to_index<Usart<2>, MCU> : std::integral_constant<uint8_t, 0x17>{};
                template<AVR::Concepts::AtDa32 MCU> struct user_to_index<Usart<3>, MCU> : std::integral_constant<uint8_t, 0x18>{};
                template<AVR::Concepts::AtDa32 MCU> struct user_to_index<TcaCntA<0>, MCU> : std::integral_constant<uint8_t, 0x1b>{};
                template<AVR::Concepts::AtDa32 MCU> struct user_to_index<TcaCntB<0>, MCU> : std::integral_constant<uint8_t, 0x1c>{};
                template<AVR::Concepts::AtDa32 MCU> struct user_to_index<TcbCapt<0>, MCU> : std::integral_constant<uint8_t, 0x1f>{};
                template<AVR::Concepts::AtDa32 MCU> struct user_to_index<TcbCount<0>, MCU> : std::integral_constant<uint8_t, 0x20>{};
                template<AVR::Concepts::AtDa32 MCU> struct user_to_index<TcbCapt<1>, MCU> : std::integral_constant<uint8_t, 0x21>{};
                template<AVR::Concepts::AtDa32 MCU> struct user_to_index<TcbCount<1>, MCU> : std::integral_constant<uint8_t, 0x22>{};
                template<AVR::Concepts::AtDa32 MCU> struct user_to_index<TcbCapt<2>, MCU> : std::integral_constant<uint8_t, 0x23>{};
                template<AVR::Concepts::AtDa32 MCU> struct user_to_index<TcbCount<2>, MCU> : std::integral_constant<uint8_t, 0x24>{};
                template<AVR::Concepts::AtDa32 MCU> struct user_to_index<TcbCapt<3>, MCU> : std::integral_constant<uint8_t, 0x25>{};
                template<AVR::Concepts::AtDa32 MCU> struct user_to_index<TcbCount<3>, MCU> : std::integral_constant<uint8_t, 0x26>{};
