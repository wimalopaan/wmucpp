...
//                template<AVR::Concepts::AtDa32 MCU> struct map_input<Tca0<0>, 1, MCU> : std::integral_constant<std::byte, 0x0a_B> {};
                template<AVR::Concepts::AtDa32 MCU> struct map_input<Tca0<1>, 1, MCU> : std::integral_constant<std::byte, 0x0a_B> {};
                ...
                template<AVR::Concepts::AtDa32 MCU> struct map_input<Tca0<2>, 2, MCU> : std::integral_constant<std::byte, 0x0a_B> {};
