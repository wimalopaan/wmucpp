    ...
    namespace Ccl {
        namespace Input {
            ...
            namespace detail {
                ...
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Mask, 0, MCU> : std::integral_constant<std::byte, 0x00_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Feedback, 0, MCU> : std::integral_constant<std::byte, 0x01_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Link, 0, MCU> : std::integral_constant<std::byte, 0x02_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Event<A>, 0, MCU> : std::integral_constant<std::byte, 0x03_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Event<B>, 0, MCU> : std::integral_constant<std::byte, 0x04_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<IOPin, 0, MCU> : std::integral_constant<std::byte, 0x05_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Ac<0>, 0, MCU> : std::integral_constant<std::byte, 0x06_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Zcd<0>, 0, MCU> : std::integral_constant<std::byte, 0x07_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Usart<0>, 0, MCU> : std::integral_constant<std::byte, 0x08_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Spi0, 0, MCU> : std::integral_constant<std::byte, 0x09_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Tca0<0>, 0, MCU> : std::integral_constant<std::byte, 0x0a_B> {};
//                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Tca0<1>, 0, MCU> : std::integral_constant<std::byte, 0x0b_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Tcb<0>, 0, MCU> : std::integral_constant<std::byte, 0x0c_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Tcd<0>, 0, MCU> : std::integral_constant<std::byte, 0x0d_B> {};

                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Mask, 1, MCU> : std::integral_constant<std::byte, 0x00_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Feedback, 1, MCU> : std::integral_constant<std::byte, 0x01_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Link, 1, MCU> : std::integral_constant<std::byte, 0x02_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Event<A>, 1, MCU> : std::integral_constant<std::byte, 0x03_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Event<B>, 1, MCU> : std::integral_constant<std::byte, 0x04_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<IOPin, 1, MCU> : std::integral_constant<std::byte, 0x05_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Ac<1>, 1, MCU> : std::integral_constant<std::byte, 0x06_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Zcd<1>, 1, MCU> : std::integral_constant<std::byte, 0x07_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Usart<1>, 1, MCU> : std::integral_constant<std::byte, 0x08_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Spi0, 1, MCU> : std::integral_constant<std::byte, 0x09_B> {};
//                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Tca0<0>, 1, MCU> : std::integral_constant<std::byte, 0x0a_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Tca0<1>, 1, MCU> : std::integral_constant<std::byte, 0x0a_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Tcb<1>, 1, MCU> : std::integral_constant<std::byte, 0x0c_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Tcd<0>, 1, MCU> : std::integral_constant<std::byte, 0x0d_B> {};

                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Mask, 2, MCU> : std::integral_constant<std::byte, 0x00_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Feedback, 2, MCU> : std::integral_constant<std::byte, 0x01_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Link, 2, MCU> : std::integral_constant<std::byte, 0x02_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Event<A>, 2, MCU> : std::integral_constant<std::byte, 0x03_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Event<B>, 2, MCU> : std::integral_constant<std::byte, 0x04_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<IOPin, 2, MCU> : std::integral_constant<std::byte, 0x05_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Ac<2>, 2, MCU> : std::integral_constant<std::byte, 0x06_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Zcd<2>, 2, MCU> : std::integral_constant<std::byte, 0x07_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Usart<2>, 2, MCU> : std::integral_constant<std::byte, 0x08_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Spi0, 2, MCU> : std::integral_constant<std::byte, 0x09_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Tca0<2>, 2, MCU> : std::integral_constant<std::byte, 0x0a_B> {};
//                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Tca0<1>, 2, MCU> : std::integral_constant<std::byte, 0x0b_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Tcb<2>, 2, MCU> : std::integral_constant<std::byte, 0x0c_B> {};
                template<AVR::Concepts::AtDaSeries MCU> struct map_input<Tcd<0>, 2, MCU> : std::integral_constant<std::byte, 0x0d_B> {};
