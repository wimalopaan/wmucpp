...
namespace std {
    template<>
    struct enable_bitmask_operators<AVR::ATMega324PB::Status::Bits>  : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega324PB::Timer8Interrupts::Flags>  : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega324PB::Timer8Interrupts::Mask>  : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega324PB::Timer16Interrupts::Flags>  : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega324PB::Timer16Interrupts::Mask>  : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega324PB::Usart::SRA>  : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega324PB::Usart::SRB>  : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega324PB::Usart::SRC>  : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega324PB::Timer8Bit::TCCRA>  : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega324PB::Timer8Bit::TCCRB>  : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega324PB::Timer16Bit::TCCRA>  : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega324PB::Timer16Bit::TCCRB>  : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega324PB::TWI::TWS>  : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega324PB::TWI::TWC>  : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega324PB::Adc::SRA>  : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega324PB::Adc::SRB>  : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega324PB::Adc::MUX>  : std::true_type {};
}
