...
namespace AVR {
    ...
    struct ATMega328P final
    {
        ...
        struct Interrupt {
            ...
            static constexpr const uint8_t ext_int_count = 2;
    ...
    template<>
    constexpr bool ATMega328P::is_atomic<uint8_t>() {return true;}
}

namespace std {
    template<>
    struct enable_bitmask_operators<AVR::ATMega328P::Status::Bits> : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega328P::Timer8Interrupts::Flags> : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega328P::Timer8Interrupts::Mask> : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega328P::Timer16Interrupts::Flags> : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega328P::Timer16Interrupts::Mask> : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega328P::Usart::SRA> : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega328P::Usart::SRB> : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega328P::Usart::SRC> : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega328P::Timer8Bit::TCCRA> : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega328P::Timer8Bit::TCCRB> : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega328P::Timer16Bit::TCCRA> : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega328P::Timer16Bit::TCCRB> : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega328P::Spi::CR> : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega328P::Spi::SR> : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega328P::TWI::TWS> : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega328P::TWI::TWC> : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega328P::Adc::SRA> : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega328P::Adc::SRB> : std::true_type {};
    template<>
    struct enable_bitmask_operators<AVR::ATMega328P::Adc::MUX> : std::true_type {};
}

namespace AVR {
    
    template<>
    struct ATMega328P::GPIOR::Address<0> {
        inline static constexpr uintptr_t value = 0x3e;
    };
    template<>
    struct ATMega328P::GPIOR::Address<1> {
        inline static constexpr uintptr_t value = 0x4a;
    };
    template<>
    struct ATMega328P::GPIOR::Address<2> {
    ...
    struct ATMega328P::Timer8Bit::PrescalerBits<0> {
        static constexpr auto values = AVR::Util::Timer::prescalerValues10Bit<ATMega328P::Timer8Bit::TCCRB>;
    };
    ...
    struct ATMega328P::Timer8Bit::PrescalerBits<2> {
        static constexpr auto values = AVR::Util::Timer::prescalerValues10BitExtended<ATMega328P::Timer8Bit::TCCRB>;
    };
    ...
    struct ATMega328P::Timer16Bit::PrescalerBits<1> {
        static constexpr auto values = AVR::Util::Timer::prescalerValues10Bit<ATMega328P::Timer16Bit::TCCRB>;
    };
    template<>
